export const REGIONS_2_4 = Object.freeze({
  library: {
    ...
    standard: [
      ...
      { id:'lib-crown', type:'sentence', prompt:'Baue: Das Buch ist auf dem Tisch.', tokens:['The','book','is','on','the','table.'], correct:['The','book','is','on','the','table.'] },
    ],
    boss: [
  ...
  wildlife: {
    ...
    standard: [
      ...
      { id:'wild-crown', type:'sentence', prompt:'Baue: Der Tiger ist größer als die Katze.', tokens:['The','tiger','is','bigger','than','the','cat.'], correct:['The','tiger','is','bigger','than','the','cat.'] },
    ],
    boss: [
      ...
      { id:'blackfinn-3', type:'sentence', prompt:'Finde die Spur: Der Wolf ist stärker als der Hund.', tokens:['The','wolf','is','stronger','than','the','dog.'], correct:['The','wolf','is','stronger','than','the','dog.'], counter:true },
    ],
  },
  home: {
    ...
    standard: [
      { id:'home-1', type:'choice', prompt:'die Küche', answers:['the kitchen','the bedroom','the garden'], correct:'the kitchen' },
      { id:'home-2', type:'choice', prompt:'unter dem Tisch', answers:['on the table','under the table','next to the chair'], correct:'under the table' },
      { id:'home-3', type:'choice', prompt:'Der Schlüssel ist neben der Tür.', answers:['The key is under the bed.','The key is next to the door.','The key is in the kitchen.'], correct:'The key is next to the door.' },
      { id:'home-4', type:'choice', prompt:'das Fenster', answers:['the window','the wall','the floor'], correct:'the window' },
      { id:'home-crown', type:'sentence', prompt:'Baue: Die Lampe steht neben dem Bett.', tokens:['The','lamp','is','next','to','the','bed.'], correct:['The','lamp','is','next','to','the','bed.'] },
    ],
    boss: [
      ...
      { id:'roderick-3', type:'sentence', prompt:'Revanche-Satz: Der Schlüssel liegt in der Schublade.', tokens:['The','key','is','in','the','drawer.'], correct:['The','key','is','in','the','drawer.'], counter:true },
    ],
  },
});
